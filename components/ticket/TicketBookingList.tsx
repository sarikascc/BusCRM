                ...
                >
                  ...
                  <td className="px-6 py-4">
                    {ticket.settlement_id ? (
                      ...
                      <span className="text-[10px] bg-slate-100 text-slate-500 px-2 py-1 rounded-[6px] font-black border border-slate-200 uppercase tracking-widest shadow-sm flex items-center gap-1 w-fit">
